...
const PROPERTIES = [
  {
    id: 1, title: "Luxury Studio – Midtown West",
    address: "350 W 42nd St, New York, NY", neighborhood: "Midtown West",
    price: 2982, beds: 1, baths: 1, sqft: 620, type: "Studio",
    lat: 40.7589, lng: -73.9937,
    images: [
    ...
    available: "Available Now", phone: "267-493-1561",
    description: "Stunning studio with floor-to-ceiling windows and panoramic Midtown views. Renovated with Italian marble finishes, chef's kitchen, and smart home features throughout.",
    rating: 4.8, reviews: 124, badge: "Special Offer", tour3d: true,
  },
  {
    id: 2, title: "Elegant 2BR – Upper West Side",
    address: "200 W 86th St, New York, NY", neighborhood: "Upper West Side",
    price: 4200, beds: 2, baths: 2, sqft: 1100, type: "Apartment",
    lat: 40.7849, lng: -73.98,
    images: [
    ...
    available: "Available Jun 1", phone: "267-493-1562",
    description: "Pre-war elegance meets modern living. High ceilings, original hardwood floors, and generous closet space in one of the UWS's most sought-after buildings.",
    rating: 4.9, reviews: 89, badge: "3D Tour", tour3d: true,
  },
  {
    id: 3, title: "Bright 1BR – Chelsea",
    address: "245 W 19th St, New York, NY", neighborhood: "Chelsea",
    price: 3507, beds: 1, baths: 1, sqft: 780, type: "Apartment",
    lat: 40.7434, lng: -73.9997,
    images: [
    ...
    available: "Available Now", phone: "267-493-1563",
    description: "Sun-drenched one-bedroom with open city views. Steps from the High Line, Chelsea Market, and top galleries. Central A/C and in-unit washer/dryer.",
    rating: 4.7, reviews: 201, badge: "Special Offer", tour3d: false,
  },
  {
    id: 4, title: "Modern 2BR – Brooklyn Heights",
    address: "80 Remsen St, Brooklyn, NY", neighborhood: "Brooklyn Heights",
    price: 3800, beds: 2, baths: 1, sqft: 950, type: "Apartment",
    lat: 40.6964, lng: -73.9964,
    images: [
    ...
    available: "Available May 15", phone: "267-493-1564",
    description: "Spacious two-bedroom with private terrace overlooking the Brooklyn Promenade. Manhattan skyline views. Quiet, tree-lined block in a prime location.",
    rating: 4.6, reviews: 67, badge: "New Listing", tour3d: true,
  },
  {
    id: 5, title: "Penthouse Studio – Williamsburg",
    address: "130 S 4th St, Brooklyn, NY", neighborhood: "Williamsburg",
    price: 3200, beds: 1, baths: 1, sqft: 700, type: "Penthouse",
    lat: 40.7126, lng: -73.962,
    images: [
    ...
    available: "Available Now", phone: "267-493-1565",
    description: "Top-floor penthouse studio with soaring ceilings and wrap-around Manhattan views. Polished concrete floors, custom built-ins, and gourmet kitchen.",
    rating: 4.9, reviews: 156, badge: "Special Offer", tour3d: true,
  },
  {
    id: 6, title: "Classic 3BR – Park Slope",
    address: "400 7th Ave, Brooklyn, NY", neighborhood: "Park Slope",
    price: 5500, beds: 3, baths: 2, sqft: 1400, type: "Apartment",
    lat: 40.6662, lng: -73.979,
    images: [
    ...
    available: "Available Jul 1", phone: "267-493-1566",
    description: "Rare three-bedroom garden apartment in the heart of Park Slope. Private backyard, original crown molding, chef's kitchen. Steps from Prospect Park.",
    rating: 4.8, reviews: 43, badge: "Premium", tour3d: false,
  },
  {
    id: 7, title: "Sleek 1BR – Long Island City",
    address: "5-33 48th Ave, Queens, NY", neighborhood: "Long Island City",
    price: 2750, beds: 1, baths: 1, sqft: 710, type: "Apartment",
    lat: 40.744, lng: -73.949,
    images: [
    ...
    available: "Available Now", phone: "267-493-1567",
    description: "Brand new luxury one-bedroom with Manhattan skyline views from every window. Full-service amenity building. 7-min subway to Midtown.",
    rating: 4.7, reviews: 88, badge: "3D Tour", tour3d: true,
  },
  {
    id: 8, title: "Cozy 2BR – Astoria",
    address: "31-59 Crescent St, Queens, NY", neighborhood: "Astoria",
    price: 3100, beds: 2, baths: 1, sqft: 900, type: "Apartment",
    lat: 40.7707, lng: -73.9296,
    images: [
    ...
    available: "Available May 1", phone: "267-493-1568",
    description: "Charming two-bedroom in vibrant Astoria. Hardwood floors throughout, renovated kitchen, and private backyard access. Close to top dining and N/W trains.",
    rating: 4.5, reviews: 112, badge: "New Listing", tour3d: false,
  },
];
...
function createPriceIcon(price, isSelected) {
  ...
  return L.divIcon({
    html: `<div style="position:relative;background:${bg};color:#fff;padding:5px 11px;border-radius:20px;font-size:12px;font-weight:700;font-family:sans-serif;white-space:nowrap;box-shadow:0 4px 14px rgba(0,0,0,0.35);border:2px solid ${border};transform:${isSelected ? "scale(1.18)" : "scale(1)"};transition:all 0.2s;cursor:pointer;display:inline-block;">
      $${(price / 1000).toFixed(1)}k
      <div style="position:absolute;bottom:-7px;left:50%;transform:translateX(-50%);width:0;height:0;border-left:7px solid transparent;border-right:7px solid transparent;border-top:7px solid ${bg};"></div>
    </div>`,
  ...
  return (
    <motion.div
      ...
      className={`group relative bg-white rounded-2xl overflow-hidden cursor-pointer transition-all duration-300
        ${isSelected ? "ring-2 ring-red-500 shadow-xl shadow-red-100" : "shadow-md hover:shadow-xl hover:-translate-y-0.5"}`}
    >
      <div className="relative h-44 overflow-hidden">
        <img src={property.images[0]} alt={property.title}
          className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
        <div className="absolute top-2.5 left-2.5 flex gap-1.5">
          {property.tour3d && <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-slate-800 text-white tracking-wide">3D TOUR</span>}
          {property.badge && <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full tracking-wide ${BADGE_STYLES[property.badge] || "bg-gray-800 text-white"}`}>{property.badge.toUpperCase()}</span>}
        </div>
        <button onClick={e => e.stopPropagation()} className="absolute top-2.5 right-2.5 w-7 h-7 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white transition-colors">
        ...
        <div className="absolute bottom-2.5 left-2.5">
          <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${property.available === "Available Now" ? "bg-emerald-500/90 text-white" : "bg-white/80 text-slate-700"}`}>
            {property.available}
          </span>
        </div>
      </div>
        ...
        <div className="flex items-start justify-between gap-2 mb-1">
          <div>
            <div className="flex items-baseline gap-1">
              <span className="text-base font-bold text-slate-900">${property.price.toLocaleString()}</span>
    ...
    <motion.div key={property.id}
      ...
      <div className="relative h-56 shrink-0 overflow-hidden bg-slate-100">
        <AnimatePresence mode="wait">
          <motion.img key={imgIndex} src={property.images[imgIndex]} alt={property.title}
        ...
        <button onClick={() => setImgIndex(p => (p - 1 + property.images.length) % property.images.length)}
        ...
        <button onClick={() => setImgIndex(p => (p + 1) % property.images.length)}
        ...
        <div className="absolute top-3 left-3 flex gap-1.5">
          {property.tour3d && <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-slate-800 text-white">3D TOUR</span>}
          <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${BADGE_STYLES[property.badge] || "bg-gray-800 text-white"}`}>{property.badge?.toUpperCase()}</span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-5">
        <div className="flex items-start justify-between mb-1">
          <div>
            <p className="text-2xl font-bold text-slate-900">${property.price.toLocaleString()}<span className="text-sm font-normal text-slate-400">/mo</span></p>
            <p className="text-xs text-slate-400 mt-0.5">{property.neighborhood}</p>
          </div>
          <div className="text-right">
            <div className="flex items-center justify-end gap-1"><Stars rating={property.rating} /><span className="text-xs font-semibold text-slate-700">{property.rating}</span></div>
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          {[{ label: "Bedrooms", value: property.beds }, { label: "Bathrooms", value: property.baths }, { label: "Sq Ft", value: property.sqft.toLocaleString() }].map(({ label, value }) => (
        ...
        <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold mb-4 ${property.available === "Available Now" ? "bg-emerald-50 text-emerald-700" : "bg-amber-50 text-amber-700"}`}>
          <span className={`w-1.5 h-1.5 rounded-full ${property.available === "Available Now" ? "bg-emerald-500" : "bg-amber-500"}`} />
          {property.available}
        </div>
        ...
        <div className="mb-5">
          ...
          <div className="flex flex-wrap gap-2">
            {property.amenities.map(a => <span key={a} className="text-xs px-3 py-1 bg-slate-100 text-slate-600 rounded-full font-medium">{a}</span>)}
          </div>
        </div>
        <div className="mb-5">
        ...
        <div className="flex flex-col gap-2.5">
          <button className="w-full py-3 bg-red-500 hover:bg-red-600 text-white text-sm font-bold rounded-xl transition-colors">Check Availability</button>
          <a href={`tel:${property.phone}`} className="w-full py-3 border border-slate-200 text-slate-700 text-sm font-semibold rounded-xl text-center hover:bg-slate-50 transition-colors">📞 {property.phone}</a>
          <button className="w-full py-3 border border-slate-200 text-slate-700 text-sm font-semibold rounded-xl hover:bg-slate-50 transition-colors">Schedule a Tour</button>
        </div>
      </div>
    </motion.div>
  );
...
export default function Listings() {
  ...
  const [filters, setFilters] = useState({ type: "For rent", price: "Price", beds: "Beds & baths", propType: "Property type" });
  ...
  const filteredProperties = PROPERTIES.filter(p => {
    ...
    return p.address.toLowerCase().includes(q) || p.neighborhood.toLowerCase().includes(q) || p.title.toLowerCase().includes(q);
  });
      ...
      <motion.div initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.4 }}
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <div className="relative flex-1 min-w-60">
            ...
            <input type="text" placeholder="Address, neighborhood, city, ZIP" value={searchQuery} onChange={e => setSearchQuery(e.target.value)}
          ...
          <button className="text-xs font-semibold px-4 py-2.5 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-colors shadow-sm">Save search</button>
        </div>
          ...
          <MapContainer center={mapCenter} zoom={mapZoom} style={{ height: "100%", width: "100%" }} zoomControl={false}>
            ...
            {filteredProperties.map(property => (
              <Marker key={property.id} position={[property.lat, property.lng]}
                ...
                eventHandlers={{ click: () => { selectProperty(property); setShowDetail(true); } }} />
            ))}
          </MapContainer>
          <style>{`.leaflet-control-attribution { font-size: 9px !important; opacity: 0.6; } .leaflet-bottom.leaflet-right { bottom: 4px; right: 4px; }`}</style>
          <div className="absolute bottom-6 right-4 z-[999] flex flex-col gap-2">
            <button onClick={() => { setMapCenter([40.7484, -73.9967]); setMapZoom(12); }}
        ...
        <div className="relative w-[420px] shrink-0 flex flex-col bg-white border-l border-slate-100 overflow-hidden">
              ...
              {filteredProperties.length === 0 ? (
                ...
                filteredProperties.map((property, index) => (
                  <div key={property.id} ref={el => (cardRefs.current[property.id] = el)}>
                    <PropertyCard property={property} isSelected={selectedProperty?.id === property.id}
                      onClick={() => { selectProperty(property); setShowDetail(true); }} index={index} />
                  </div>
                ))
              )}
            </AnimatePresence>
          ...
          <AnimatePresence>
            {showDetail && selectedProperty && (
              <DetailPanel property={selectedProperty}
                onClose={() => { setShowDetail(false); setSelectedProperty(null); setMapCenter([40.7484, -73.9967]); setMapZoom(12); }} />
            )}
          </AnimatePresence>
        </div>
      </div>
