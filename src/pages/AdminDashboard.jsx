    ...
    <div style={{ minHeight: "100vh", background: "#f1f5f9" }}>
      ...
      <div style={{ padding: "20px 24px" }}>
        ...
        <div style={{ background: "white", padding: "16px", borderRadius: "12px", marginBottom: "16px" }}>
          ...
          <textarea value={feedJson} onChange={(e) => setFeedJson(e.target.value)} rows={4} style={{ width: "100%", marginBottom: "8px" }} placeholder="Paste JSON/CSV here" />
          <div style={{ display: "flex", gap: "8px" }}>
            <button onClick={handleBrokerImport} style={{ ...btn, background: "#7c3aed", color: "white" }}>Import by Name</button>
            <button onClick={handleFeedImport} style={{ ...btn, background: "#475569", color: "white" }}>Generic Import</button>
          </div>
        </div>
