...
export default function SmartMatch() {
  ...
  return (
    <section className="relative overflow-hidden py-20 sm:py-24 lg:py-28">
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-rose-50/90 via-white to-sky-50/40"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute -top-24 right-0 h-80 w-80 rounded-full bg-gradient-to-br from-rose-200/50 to-transparent blur-3xl"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute bottom-0 left-0 h-72 w-72 rounded-full bg-gradient-to-tr from-sky-200/40 to-transparent blur-3xl"
        aria-hidden
      />
